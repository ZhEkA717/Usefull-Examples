...
// // Вывод случайного числа от n до m
...
// //Должна быть описана функция сравнения, которая умеет сравнивать два 
// //переданных ей элемента массива (например a и b), и возвращать:
